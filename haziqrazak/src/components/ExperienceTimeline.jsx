...
export default function ExperienceTimeline() {
  // Only show items with type Experience
  const experienceItems = timelineData.filter(item => item.type === "Experience");
  return (
    <section className="min-h-screen w-full flex flex-col items-center justify-center bg-black text-white py-8 px-2 sm:px-4" id="experience" data-section="experience">
